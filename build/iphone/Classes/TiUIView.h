...
/**
 Base class for all Contacts_Table views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Contacts_Table view hierarchy (such as wrapped iOS UIViews) was touched.
