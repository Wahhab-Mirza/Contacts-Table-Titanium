...
/**
 The base class for all Contacts_Table modules
 */
...
/**
 Contacts_Table Platform calls this method on startup.
 */
-(void)startup;

/**
 Contacts_Table Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Contacts_Table Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Contacts_Table Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Contacts_Table Platform calls this method on resume.
 @param sender The sender of the event.
 */
