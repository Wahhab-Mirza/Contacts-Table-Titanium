...
// in simulator we redefine to format for Contacts_Table Developer console
...
{\
	NSString * exceptionName = [@"org.contacts_table." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.contacts_table";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIContacts_TableNativeItemNone = -1, 
	UIContacts_TableNativeItemSpinner = -2,
	UIContacts_TableNativeItemProgressBar = -3,
	
	UIContacts_TableNativeItemSlider = -4,
	UIContacts_TableNativeItemSwitch = -5,
	UIContacts_TableNativeItemMultiButton = -6,
	UIContacts_TableNativeItemSegmented = -7,
	
	UIContacts_TableNativeItemTextView = -8,
	UIContacts_TableNativeItemTextField = -9,
	UIContacts_TableNativeItemSearchBar = -10,
	
	UIContacts_TableNativeItemPicker = -11,
	UIContacts_TableNativeItemDatePicker = -12,
	
	UIContacts_TableNativeItemInfoLight = -13,
	UIContacts_TableNativeItemInfoDark = -14,
	
	UIContacts_TableNativeItemDisclosure = -15,
	
	UIContacts_TableNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Contacts_Table instances of
