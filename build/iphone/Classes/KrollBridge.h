...
@interface Contacts_TableObject : KrollCoverageObject {
#else
@interface Contacts_TableObject : KrollObject {
#endif
@private
...
extern NSString * Contacts_Table$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Contacts_TableObject *_contacts_table;
    KrollObject* console;
	BOOL shutdown;
