...
//Rare exceptions to indicate a bug in the _contacts_table code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Contacts_Table proxies.
 */
