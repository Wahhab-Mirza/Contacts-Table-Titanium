...
//@interface Contacts_TableObject : NSObject
//@end

@interface Contacts_TableObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Contacts_TableObject class]])
		{
			for (NSString *key in [[(Contacts_TableObject*)o modules] allKeys])
			{
